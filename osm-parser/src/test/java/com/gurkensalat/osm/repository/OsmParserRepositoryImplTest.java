...
public class OsmParserRepositoryImplTest
{
    ...
    public void parseMosqueGermeringData() throws IOException
    {
        ...
        // Strange bounding box generated by Osmosis
        assertEquals(8.97465, root.getBounds().getMinlon(), 0.001);
        assertEquals(47.22839, root.getBounds().getMinlat(), 0.001);

        assertEquals(14.09027, root.getBounds().getMaxlon(), 0.001);
        assertEquals(50.56779, root.getBounds().getMaxlat(), 0.001);
    }
    ...
    public void parseMosqueGermeringDataFromAPI() throws IOException
    {
        ...
        // Data loaded from the API has no bounding box
        assertNull(root.getBounds());
    }
    ...
    public void parsePlaceAnkaraData() throws IOException
    {
        ...
        // Strange bounding box generated by Osmosis
        assertEquals(35.71373, root.getBounds().getMinlon(), 0.001);
        assertEquals(25.59553, root.getBounds().getMinlat(), 0.001);

        assertEquals(42.45132, root.getBounds().getMaxlon(), 0.001);
        assertEquals(44.83384, root.getBounds().getMaxlat(), 0.001);
    }
